...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 967)), "/Users/yinmanman/Downloads/nextjs_13_demo/app/profile/edit/page.js"],
    ...
    const pages = ["/Users/yinmanman/Downloads/nextjs_13_demo/app/profile/edit/page.js"];
...
const actions = {
'e3d98190757879ea62407dc36361cf864758aa78': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 967)).then(mod => mod["$$ACTION_0"]),
}
...
module.exports = {
  'e3d98190757879ea62407dc36361cf864758aa78': endpoint.bind(null, 'e3d98190757879ea62407dc36361cf864758aa78'),
}
...
function Profile() {
    async function addProfile(data) {
        return $$ACTION_0(addProfile.$$bound);
    }
    addProfile.$$typeof = Symbol.for("react.server.reference");
    addProfile.$$id = "e3d98190757879ea62407dc36361cf864758aa78";
    addProfile.$$bound = null;
...
async function $$ACTION_0(closure, data = closure[0]) {
// console.log(data);
}
...
var __webpack_exports__ = __webpack_require__.X(0, [79,704,385], () => (__webpack_exec__(8600)));
