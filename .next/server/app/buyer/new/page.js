...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 944)), "/Users/yinmanman/Downloads/nextjs_13_demo/app/buyer/new/page.js"],
    ...
    const pages = ["/Users/yinmanman/Downloads/nextjs_13_demo/app/buyer/new/page.js"];
    ...
    const originalPathname = "/buyer/new/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3453))
...
;// CONCATENATED MODULE: ./app/api/buyer/create.js
...
/* harmony default export */ const create = ((0,action_client_wrapper/* default */.Z)("2f51557dc1b28acd19225d0f4e5187ad3eacf20e"));


// EXTERNAL MODULE: ./app/api/buyer/list.js
var list = __webpack_require__(1855);
;// CONCATENATED MODULE: ./app/buyer/new/page.js
...
function BuyerNew() {
    ...
    const [first_name, setFirstName] = (0,react_experimental_.useState)("");
    const [last_name, setLastName] = (0,react_experimental_.useState)("");
    const [mobile, setMobile] = (0,react_experimental_.useState)("");
...
/* harmony import */ var _prisma__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8947);
/* harmony import */ var private_next_rsc_action_proxy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5553);
/* __next_internal_action_entry_do_not_use__ default */ 

async function handler(req, res) {
    const result = await _prisma__WEBPACK_IMPORTED_MODULE_1__["default"].buyer.create({
        data: req
    });
...
handler.$$id = "2f51557dc1b28acd19225d0f4e5187ad3eacf20e";
handler.$$bound = null;
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/yinmanman/Downloads/nextjs_13_demo/app/buyer/new/page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [79,704,257,385,552], () => (__webpack_exec__(8892)));
